...
SQL is optimized for the sole puropse of querying data.
- [ ] Why do tables need a `primary key`?
A primary key uniquely identifies every row in a database table. It ensures row level accessibilty.
